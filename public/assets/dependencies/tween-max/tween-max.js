...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function() {
        ...
        _gsScope._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function(a, b, c) {
                ...
                f.version = "1.20.2", k.constructor = f, k.kill()._gc = !1, f.killTweensOf = f.killDelayedCallsTo = c.killTweensOf, f.getTweensOf = c.getTweensOf, f.lagSmoothing = c.lagSmoothing, f.ticker = c.ticker, f.render = c.render, k.invalidate = function() {
                    ...
                    var d, e = this.ratio,
                        f = this.vars.imassetsteRender || a.imassetsteRender;
                    ...
                    return c.runBackwards = !0, c.imassetsteRender = 0 != c.imassetsteRender, new f(a, b, c)
                }, f.fromTo = function(a, b, c, d) {
                    return d.startAt = c, d.imassetsteRender = 0 != d.imassetsteRender && 0 != c.imassetsteRender, new f(a, b, d)
                    ...
                    return c.runBackwards = !0, c.imassetsteRender = 0 != c.imassetsteRender, f.staggerTo(a, b, c, d, e, g, h)
                }, f.staggerFromTo = f.allFromTo = function(a, b, c, d, e, g, h, i) {
                    return d.startAt = c, d.imassetsteRender = 0 != d.imassetsteRender && 0 != c.imassetsteRender, f.staggerTo(a, b, d, e, g, h, i)
                ...
                return d.version = "1.20.2", q.constructor = d, q.kill()._gc = q._forcingPlayhead = q._hasPause = !1, q.to = function(a, b, d, e) {
                    ...
                    return c.imassetsteRender = 0 != c.imassetsteRender, c.runBackwards = !0, this.staggerTo(a, b, c, d, e, f, g, h)
                }, q.staggerFromTo = function(a, b, c, d, e, f, g, h, i) {
                    return d.startAt = c, d.imassetsteRender = 0 != d.imassetsteRender && 0 != c.imassetsteRender, this.staggerTo(a, b, d, e, f, g, h, i)
                }, q.call = function(a, b, d, e) {
                    return this.add(c.delayedCall(0, a, b, d), e)
                }, q.set = function(a, b, d) {
                    return d = this._parseTimeOrLabel(d, 0, !0), null == b.imassetsteRender && (b.imassetsteRender = d === this._time && !this._paused), this.add(new c(a, 0, b), d)
                ...
                return k.constructor = d, k.kill()._gc = !1, d.version = "1.20.2", k.invalidate = function() {
                    ...
                    c = c || {}, a = this._parseTimeOrLabel(a), c.startAt = {
                        ...
                        onCompleteParams: [a],
                        callbackScope: this
                    }, c.imassetsteRender = c.imassetsteRender !== !1;
    ...
    function(a, b) {
        ...
        if (!e.TweenLite) {
            ...
            var D = t("core.Animation", function(a, b) {
                if (this.vars = b = b || {}, this._duration = this._totalDuration = a || 0, this._delay = Number(b.delay) || 0, this._timeScale = 1, this._active = b.imassetsteRender === !0, this.data = b.data, this._reversed = b.reversed === !0, X) {
                    j || i.wake();
            ...
            var G = t("TweenLite", function(b, c, d) {
                    ...
                    (this.vars.imassetsteRender || 0 === c && 0 === this._delay && this.vars.imassetsteRender !== !1) && (this._time = -m, this.render(Math.min(0, -this._delay)))
                }, !0),
                H = function(b) {
            ...
            h._init = function() {
                var a, b, c, d, e, f, g = this.vars,
                    ...
                    i = this._duration,
                    j = !!g.imassetsteRender,
                    k = g.ease;
                if (g.startAt) {
                    this._startAt && (this._startAt.render(-1, !0), this._startAt.kill()), e = {};
                    for (d in g.startAt) e[d] = g.startAt[d];
                    if (e.overwrite = !1, e.imassetsteRender = !0, e.lazy = j && g.lazy !== !1, e.startAt = e.delay = null, e.onUpdate = g.onUpdate, e.onUpdateScope = g.onUpdateScope || g.callbackScope || this, this._startAt = G.to(this.target, 0, e), j)
                    ...
                    if (this._startAt) this._startAt.render(-1, !0), this._startAt.kill(), this._startAt = null;
                        ...
                        if (c.overwrite = 0, c.data = "isFromStart", c.lazy = j && g.lazy !== !1, c.imassetsteRender = j, this._startAt = G.to(this.target, 0, c), j) {
                            if (0 === this._time) return
                        } else this._startAt._init(), this._startAt._enabled(!1), this.vars.imassetsteRender && (this._startAt = null)
                ...
                return this._notifyPluginsOfEnabled && G._onPluginEvent("_onDisable", this), this._firstPT = this._overwrittenProps = this._startAt = this._onUpdate = null, this._notifyPluginsOfEnabled = this._active = this._lazy = !1, this._propLookup = this._targets ? {} : [], D.prototype.invalidate.call(this), this.vars.imassetsteRender && (this._time = -m, this.render(Math.min(0, -this._delay))), this
            }, h._enabled = function(a, b) {
                ...
                return c.runBackwards = !0, c.imassetsteRender = 0 != c.imassetsteRender, new G(a, b, c)
            }, G.fromTo = function(a, b, c, d) {
                return d.startAt = c, d.imassetsteRender = 0 != d.imassetsteRender && 0 != c.imassetsteRender, new G(a, b, d)
